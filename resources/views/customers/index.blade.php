                    ...
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Customers tables</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <a href="{{route('customers.create')}}" class="btn btn-sm btn-secondary">
                                            Tambah Customer
                                        </a>
                                        <table class="table">
                                            <thead>
                                                ...
                                                @foreach($users as $row)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('customers.destroy', $row->id) }}"
                                                                method="POST" style="display: inline"
                                                                onsubmit="return confirm('Do you really want to delete {{ $row->customer_name }}?');">
                                                                @csrf
                                                                @method('DELETE')
